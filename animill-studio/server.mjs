...
function prepareNanaStudioHtml(source) {
  ...
  html = html.replace('</style>', '.nana-output-top-card,.nana-settings-content .card,#tool-lipsync > .section-body { background:linear-gradient(180deg,rgba(255,255,255,.055),rgba(255,255,255,.018)) !important; box-shadow:inset 0 1px 0 rgba(255,255,255,.06),0 8px 24px rgba(0,0,0,.22); } .nana-settings-content .card { border-color:var(--border); border-radius:0 !important; clip-path:polygon(7px 0,100% 0,100% calc(100% - 7px),calc(100% - 7px) 100%,7px 100%,0 calc(100% - 7px),0 7px); } .nana-settings-content .card-title,#tool-lipsync .card-title { color:var(--accent) !important; font-weight:800; letter-spacing:.12em; } .nana-settings-content .btn,.nana-settings-content .toolbar-btn,.nana-settings-content .pill,.nana-settings-content .gen-mode-btn,.nana-settings-content .engine-tile,#tool-lipsync .btn { border-radius:0 !important; clip-path:polygon(6px 0,100% 0,calc(100% - 6px) 100%,0 100%); transition:background .16s ease,border-color .16s ease,color .16s ease,filter .16s ease,transform .16s ease !important; } .nana-settings-content .btn:hover,.nana-settings-content .toolbar-btn:hover,.nana-settings-content .pill:hover,.nana-settings-content .gen-mode-btn:hover,.nana-settings-content .engine-tile:hover,#tool-lipsync .btn:hover { transform:translateY(-1px); border-color:var(--accent) !important; color:var(--accent2) !important; background:rgba(242,201,104,.1) !important; } .nana-settings-content .btn-primary,#tool-lipsync .btn-primary { background:linear-gradient(135deg,rgba(242,201,104,.92),rgba(118,255,195,.72)) !important; color:#080a0d !important; border-color:var(--accent) !important; } .nana-settings-content .input,.nana-settings-content textarea,.nana-settings-content select,#tool-lipsync input { border-radius:0 !important; clip-path:polygon(5px 0,100% 0,calc(100% - 5px) 100%,0 100%); background:rgba(0,0,0,.34) !important; border-color:var(--border-hi) !important; color:var(--text) !important; caret-color:var(--accent); } .nana-settings-content .input:focus,.nana-settings-content textarea:focus,.nana-settings-content select:focus,#tool-lipsync input:focus { border-color:var(--accent) !important; box-shadow:0 0 0 1px rgba(242,201,104,.18),0 0 18px rgba(242,201,104,.08); } .nana-settings-content .pill.active,.nana-settings-content .gen-mode-btn.active,.nana-settings-content .engine-tile.active { color:#080a0d !important; background:linear-gradient(135deg,rgba(242,201,104,.96),rgba(118,255,195,.78)) !important; border-color:var(--accent) !important; box-shadow:0 0 18px rgba(242,201,104,.18); } .nana-settings-content .engine-tile { background:rgba(255,255,255,.035) !important; border-color:var(--border) !important; } .nana-settings-content .engine-tile.active { background:linear-gradient(135deg,rgba(242,201,104,.22),rgba(118,255,195,.14)) !important; color:var(--text) !important; } .nana-settings-content .engine-tile.active div:first-child { color:var(--accent2) !important; } .nana-settings-content .card-badge { border-radius:0 !important; clip-path:polygon(4px 0,100% 0,calc(100% - 4px) 100%,0 100%); } .nana-settings-content input[type=range] { accent-color:var(--accent); } #tool-lipsync > .section-head .section-id { color:var(--accent); } #tool-lipsync > .section-head .minimize-btn { border-radius:0; clip-path:polygon(4px 0,100% 0,calc(100% - 4px) 100%,0 100%); } #tool-lipsync > .section-body .btn { border-radius:0 !important; } </style>');
  html = html.replace('</style>', 'body { cursor:none; background:radial-gradient(circle at var(--mx,50%) var(--my,50%),rgba(242,201,104,.08),transparent 24rem),var(--bg); } body:before { content:""; position:fixed; inset:0; z-index:0; pointer-events:none; background:radial-gradient(circle at var(--mx,50%) var(--my,50%),rgba(118,255,195,.08),transparent 18rem); } .animill-nana-halo,.animill-nana-cursor { position:fixed; left:0; top:0; pointer-events:none; z-index:100001; transform:translate3d(var(--mx,50vw),var(--my,50vh),0); } .animill-nana-halo { width:36px; height:36px; margin:-18px 0 0 -18px; border:1px solid rgba(118,255,195,.36); border-radius:50%; box-shadow:0 0 24px rgba(118,255,195,.18); opacity:.7; transition:transform .12s ease,opacity .12s ease; } .animill-nana-cursor { width:10px; height:10px; margin:-5px 0 0 -5px; background:var(--accent); clip-path:polygon(50% 0,100% 50%,50% 100%,0 50%); box-shadow:0 0 22px rgba(242,201,104,.9); transition:transform .08s ease; } .animill-nana-halo.is-hover { transform:translate3d(var(--mx,50vw),var(--my,50vh),0) scale(1.35); opacity:.95; } .animill-nana-chrome,.layout { position:relative; z-index:1; } .animill-nana-chrome { clip-path:polygon(10px 0,100% 0,calc(100% - 10px) 100%,0 100%); } @media (pointer:coarse) { body { cursor:auto; } .animill-nana-halo,.animill-nana-cursor { display:none; } } </style>');
  html = html.replace('</style>', '/* ANIMILL Advanced final geometry pass: recessed stage, exact reticle, no layout-jank hover. */ body { background:var(--bg) !important; } body:before { background:radial-gradient(circle at var(--mx,50vw) var(--my,50vh),rgba(242,201,104,.07),transparent 24rem) !important; } body:after { content:""; position:fixed; inset:0; z-index:0; pointer-events:none; opacity:.24; background:linear-gradient(rgba(255,255,255,.028) 1px,transparent 1px),linear-gradient(90deg,rgba(255,255,255,.022) 1px,transparent 1px); background-size:36px 36px; mask-image:radial-gradient(circle at var(--mx,50vw) var(--my,50vh),#000,transparent 78%); } .animill-nana-cursor,.animill-nana-halo { position:fixed; left:0; top:0; pointer-events:none; z-index:100001; transform:translate3d(var(--mx,50vw),var(--my,50vh),0) !important; transition:none !important; } .animill-nana-cursor { width:10px; height:10px; margin:-5px 0 0 -5px; background:var(--accent); clip-path:polygon(50% 0,100% 50%,50% 100%,0 50%); box-shadow:0 0 22px rgba(242,201,104,.9); } .animill-nana-halo { width:46px; height:46px; margin:-23px 0 0 -23px; border:1px solid rgba(242,201,104,.34); border-radius:0 !important; clip-path:polygon(12% 0,88% 0,100% 28%,100% 72%,88% 100%,12% 100%,0 72%,0 28%); box-shadow:none; opacity:1; } .animill-nana-halo.is-hover { transform:translate3d(var(--mx,50vw),var(--my,50vh),0) !important; opacity:1; } .nana-output-top-card { margin:0 0 14px !important; border:0 !important; background:transparent !important; box-shadow:none !important; clip-path:none !important; overflow:visible !important; } .nana-output-top-card > div:first-child { position:relative; border:1px solid var(--border) !important; border-bottom:0 !important; background:linear-gradient(180deg,rgba(255,255,255,.072),rgba(255,255,255,.026)) !important; clip-path:polygon(10px 0,100% 0,calc(100% - 10px) 100%,0 100%); } .nana-output-top-card #gen-output-area { position:relative; border:1px solid var(--border) !important; border-top:0 !important; background:radial-gradient(circle at 50% 16%,rgba(242,201,104,.11),transparent 36%),radial-gradient(circle at 50% 80%,rgba(118,255,195,.045),transparent 52%),linear-gradient(180deg,#090d13,#05070a) !important; box-shadow:inset 0 0 110px rgba(0,0,0,.72),inset 0 1px 0 rgba(255,255,255,.045) !important; clip-path:polygon(0 0,100% 0,100% calc(100% - 10px),calc(100% - 10px) 100%,10px 100%,0 calc(100% - 10px)); } .nana-output-top-card #gen-output-area:after { content:""; position:absolute; inset:12px; pointer-events:none; border:1px solid rgba(242,201,104,.08); clip-path:polygon(6px 0,100% 0,calc(100% - 6px) 100%,0 100%); } .nana-output-top-card::before { display:none; } .nana-settings-content .card,#tool-lipsync > .section-body { box-shadow:inset 0 1px 0 rgba(255,255,255,.045),inset 0 0 30px rgba(0,0,0,.25) !important; } .layout * { border-radius:0 !important; } .nana-settings-content .card,.nana-settings-content .btn,.nana-settings-content .toolbar-btn,.nana-settings-content .pill,.nana-settings-content .gen-mode-btn,.nana-settings-content .engine-tile,.nana-settings-content input,.nana-settings-content textarea,.nana-settings-content select,#tool-lipsync > .section-head,#tool-lipsync > .section-body,#tool-lipsync .btn,#tool-lipsync input { border-radius:0 !important; } .nana-settings-content .card,#tool-lipsync > .section-body { clip-path:polygon(7px 0,100% 0,100% calc(100% - 7px),calc(100% - 7px) 100%,7px 100%,0 calc(100% - 7px),0 7px); } .animill-nana-chrome,.layout { position:relative; z-index:1; } @media (pointer:coarse) { body { cursor:auto !important; } .animill-nana-halo,.animill-nana-cursor { display:none; } } </style>');
  html = html.replace('</style>', '/* ANIMILL CTA pass: shared theme and bevel geometry. */ .animill-nana-chrome { border:1px solid rgba(242,201,104,.30) !important; border-bottom-color:rgba(118,255,195,.38) !important; box-shadow:inset 0 1px 0 rgba(255,255,255,.08),0 8px 22px rgba(0,0,0,.24) !important; } .nana-output-top-card > div:first-child,.nana-output-top-card #gen-output-area { border-color:rgba(242,201,104,.28) !important; } #gen-btn { width:100% !important; min-height:46px !important; padding:12px 16px !important; background:linear-gradient(110deg,rgba(242,201,104,.96),rgba(118,255,195,.82)) !important; color:#070a0c !important; border:1px solid var(--accent) !important; clip-path:polygon(10px 0,100% 0,calc(100% - 10px) 100%,0 100%) !important; font:900 13px/1 var(--font-mono) !important; letter-spacing:.22em !important; box-shadow:0 0 24px rgba(242,201,104,.16),inset 0 1px 0 rgba(255,255,255,.52) !important; } #gen-btn:hover { filter:brightness(1.08) !important; transform:none !important; } #veo-auth-banner { border:1px solid var(--border) !important; border-left:2px solid var(--accent) !important; background:linear-gradient(90deg,rgba(242,201,104,.07),rgba(255,255,255,.025)) !important; clip-path:polygon(8px 0,100% 0,calc(100% - 8px) 100%,0 100%) !important; } #veo-auth-dot { background:var(--accent) !important; box-shadow:0 0 10px rgba(242,201,104,.62) !important; } #veo-auth-btn { min-height:34px !important; padding:9px 13px !important; background:linear-gradient(110deg,rgba(242,201,104,.20),rgba(118,255,195,.12)) !important; color:var(--accent2) !important; border:1px solid rgba(242,201,104,.52) !important; clip-path:polygon(6px 0,100% 0,calc(100% - 6px) 100%,0 100%) !important; font:900 10px/1 var(--font-mono) !important; letter-spacing:.12em !important; } #veo-auth-btn:hover { background:rgba(242,201,104,.16) !important; color:#fff !important; transform:none !important; } </style>');
...
(function () {
  ...
  var cursor = document.querySelector('.animill-nana-cursor');
  var cursorPoint = { x: window.innerWidth / 2, y: window.innerHeight / 2 };
  var cursorFrame = 0;
  function paintCursor() {
    document.documentElement.style.setProperty('--mx', cursorPoint.x + 'px');
    document.documentElement.style.setProperty('--my', cursorPoint.y + 'px');
    cursorFrame = 0;
  }
  if (cursor && window.matchMedia('(pointer:fine)').matches) {
    document.addEventListener('pointermove', function (event) {
      cursorPoint.x = event.clientX; cursorPoint.y = event.clientY;
